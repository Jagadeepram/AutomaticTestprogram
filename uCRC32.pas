...
function UpdateCRC32(InitCRC : DWORD; BufPtr : Pointer; Len : DWORD) : DWORD;
function ComputeStringCRC32(s:string):DWORD;
...
function ComputeStringCRC32(s:string):DWORD;
begin
  Result:=UpdateCrc32(32948734, @s[1], Length(s) * sizeof(char));
end;
